...
public class CommonOprations extends Pages.BasePage {
	...
	//@FindBy(xpath = "//*[@class = 'fa-external-link-square-alt fal menuicon']")
	//public WebElement ExportModule;
	
	//@FindBy(xpath = "//li[@title = 'Export']")
	//public WebElement ExportModuleArrow;
	
	//@FindBy(xpath = "//*[@title = 'Job Maintenance']")
...
//    public WebElement NewJob_AddShipper_Code;
	...
	@FindBy(xpath = "//*[@title='Courier']/span")
	...
	@FindBy(xpath = "(//*[@title='DXB - Dubai Internatinal Airport ( United Arab Emirates ) '])[2]/parent::strong/parent::div/parent::div/parent::div/parent::div/div[1]/div[2]/button")
	...
	@FindBy(xpath = "//*[@id='chkIsAgree']/parent::div/parent::div/parent::div/div[3]/div[1]/span/button")
	...
	@FindBy(xpath = "(//*[text()='Debit From Amount'])/parent::div/parent::div/parent::div/parent::div/div[3]/div/button[2]")
	...
	@FindBy(xpath = "(//*[@id='hide-in-flight-tab'])/div/button[1]")
	...
	@FindBy(xpath = "(//*[text() = 'HAWB Status'])/parent::igx-drop-down-item-group/igx-drop-down-item/span/span")
	public WebElement SelectHouseJobSearch;
	
	@FindBy(xpath = "(//*[text() = 'Association Status'])/parent::igx-drop-down-item-group/igx-drop-down-item/span/span")
